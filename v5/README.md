# Group Chat System (V5)

An enhanced, multi-user group chat application built in C using TCP sockets and multi-threading. This version improves upon V2 by binding to all network interfaces, allowing for remote connections.
...
- **Concurrency:** Multi-threaded server using `pthread` to handle multiple simultaneous client connections.
- **Networking:** Binds to `INADDR_ANY`, enabling communication over local and external networks.
